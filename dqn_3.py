...
def create_q_model():
    ...
    if WIDTH < 40:
        layer1 = layers.Conv2D(32, 3, strides=2, padding='same', activation="relu")(inputs)
        layer1a = layers.Conv2D(64, 2, strides=1, padding='same', activation="relu")(layer1)
